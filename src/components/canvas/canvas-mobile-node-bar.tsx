...
export default function CanvasMobileNodeBar({
  ...
  return (
    <div
      className="dash-pop pointer-events-auto fixed bottom-20 inset-x-3 z-30 mx-auto max-w-md rounded-2xl border border-neutral-200/90 bg-white/95 p-3.5 shadow-2xl backdrop-blur-xl md:hidden"
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <button
          ...
          className="grid h-7 w-7 shrink-0 cursor-pointer place-items-center rounded-lg text-neutral-400 hover:bg-neutral-100 hover:text-neutral-900 transition-colors"
        >
          <X className="h-4 w-4" />
        </button>
      </div>
      ...
      {node.checkpoints.length > 0 && (
        <div className="mt-2.5 flex items-center justify-between gap-3 border-t border-neutral-100 pt-2 text-xs">
          <div className="flex items-center gap-2 min-w-0">
            {nextUnfinishedCheckpoint ? (
              <>
                ...
                >
                  <Circle className="h-3.5 w-3.5 text-neutral-400 hover:text-neutral-700" />
                </button>
      ...
      <div className="mt-3 flex items-center gap-2 pt-1 border-t border-neutral-100">
        {isClaimedByMe ? (
          <button
            ...
            className="flex-1 inline-flex h-9 cursor-pointer items-center justify-center gap-1.5 rounded-xl border border-neutral-200 bg-neutral-50 px-3 text-xs font-semibold text-neutral-700 hover:bg-neutral-100 transition-colors"
          >
            <span
          ...
          <button
            ...
            className="flex-1 inline-flex h-9 cursor-pointer items-center justify-center gap-1.5 rounded-xl border border-amber-200 bg-amber-50 px-3 text-xs font-semibold text-amber-800 hover:bg-amber-100 transition-colors"
          >
          ...
          <button
            ...
            className="flex-1 inline-flex h-9 cursor-pointer items-center justify-center gap-1.5 rounded-xl border border-neutral-200 bg-neutral-50 px-3 text-xs font-semibold text-neutral-800 hover:bg-neutral-100 transition-colors"
          >
        ...
        <button
          ...
          className="inline-flex h-9 cursor-pointer items-center justify-center gap-1 rounded-xl bg-neutral-900 px-3.5 text-xs font-semibold text-white shadow-xs hover:bg-neutral-800 transition-all active:scale-[0.98]"
        >
          <span>Details</span>
