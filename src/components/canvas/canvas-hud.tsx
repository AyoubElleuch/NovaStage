    ...
    <header className="pointer-events-none absolute top-0 left-0 right-0 z-20 flex items-center justify-between p-2.5 sm:p-5 select-none gap-2">
      ...
      <div className="pointer-events-auto flex items-center gap-1.5 sm:gap-3 min-w-0">
        <Link
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-neutral-200/80 bg-white/90 text-neutral-600 shadow-sm backdrop-blur-md transition-colors hover:bg-neutral-100 hover:text-neutral-900 cursor-pointer"
        >
          <ArrowLeft className="h-4 w-4" />
        </Link>

        <div className="flex items-center gap-2 rounded-xl border border-neutral-200/80 bg-white/90 px-2.5 py-1 sm:px-3.5 sm:py-1.5 shadow-sm backdrop-blur-md min-w-0">
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              <h1 className="text-xs font-bold text-neutral-900 capitalize truncate max-w-[100px] xs:max-w-[140px] sm:max-w-[260px]">
                {projectName}
              </h1>
              <span
            ...
            <div className="flex items-center gap-1.5 text-[10px] font-medium text-neutral-500 mt-0.5">
        ...
        {/* Follow Mode Pill */}
        {followedUser && (
          <div className="hidden md:flex items-center gap-1.5 rounded-xl border border-blue-200 bg-blue-50/90 px-3 py-1.5 text-xs font-semibold text-blue-800 shadow-sm backdrop-blur-md animate-pulse">
      ...
      <div className="pointer-events-auto flex items-center gap-1.5 sm:gap-2 shrink-0">
        ...
        {(onExportMermaid || onExportJSON) && (
          <div className="relative">
            <button
              ...
              className="flex h-9 w-9 sm:w-auto items-center justify-center sm:justify-start gap-1.5 rounded-xl border border-neutral-200/80 bg-white/90 px-0 sm:px-3 text-xs font-semibold text-neutral-700 shadow-sm backdrop-blur-md hover:bg-neutral-100 hover:text-neutral-900 transition-colors cursor-pointer"
            >
        ...
        >
          {networkStatus === "online" ? (
            <>
              ...
              <span className="hidden sm:inline font-mono text-[10px] font-medium text-neutral-700">
        ...
        {inviteCode && (
          <button
            ...
            className="flex h-9 w-9 sm:w-auto items-center justify-center gap-1.5 rounded-xl border border-neutral-200/80 bg-white/90 px-0 sm:px-3 py-1.5 text-xs font-semibold text-neutral-800 shadow-sm backdrop-blur-md hover:bg-neutral-100 transition-colors cursor-pointer"
          >
            {copied ? (
              <>
              ...
              <>
                ...
                <span className="hidden sm:inline font-mono text-[11px] text-neutral-900">{inviteCode}</span>
              </>
            )}
          </button>
        )}
