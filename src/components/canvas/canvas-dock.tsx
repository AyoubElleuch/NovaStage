...
export default function CanvasDock({
  ...
  return (
    <div className="relative">
      ...
      {isQuickToolsOpen && (
        <div
          className="dash-pop absolute bottom-full mb-3 left-1/2 -translate-x-1/2 z-30 flex flex-col gap-2 rounded-2xl border border-neutral-200/90 bg-white/95 p-3 shadow-2xl backdrop-blur-xl sm:hidden min-w-[260px]"
        ...
        >
          <div className="flex items-center justify-between pb-1.5 border-b border-neutral-100">
            ...
            <button
              ...
              className="grid h-6 w-6 place-items-center rounded-md text-neutral-400 hover:bg-neutral-100 cursor-pointer"
            >
          ...
          {/* Mobile Zoom Bar */}
          <div className="flex items-center justify-between gap-1 rounded-xl bg-neutral-100/80 p-1">
            <button
              type="button"
              onClick={onZoomOut}
              title="Zoom Out"
              className="grid h-8 w-8 place-items-center rounded-lg text-neutral-700 hover:bg-white cursor-pointer"
            >
            ...
            <button
              ...
              onClick={onResetZoom}
              title="Reset Zoom"
              className="px-2 py-1 font-mono text-xs font-semibold text-neutral-800 hover:bg-white rounded-md cursor-pointer"
            >
              {zoomPct}%
            </button>
            <button
          ...
          <div className="grid grid-cols-2 gap-1.5 pt-1 text-xs">
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-neutral-200 bg-white px-2.5 py-2 font-medium text-neutral-700 hover:bg-neutral-50 cursor-pointer"
            >
              <Waypoints className="h-3.5 w-3.5 text-neutral-500" />
      ...
      >
        ...
        <div className="hidden sm:flex items-center gap-1 border-l border-neutral-200/80 pl-1.5">
          <button
            type="button"
        ...
        <div className="hidden sm:flex items-center gap-0.5 border-l border-neutral-200/80 pl-1.5">
          <button
            type="button"
            onClick={onZoomOut}
            title="Zoom Out (Ctrl -)"
