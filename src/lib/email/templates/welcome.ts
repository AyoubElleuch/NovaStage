...
Welcome to NovaStage Beta (v1.0.7)!
          ...
          <tr>
            <td style="padding:26px 32px 6px;">
              ...
              <p style="margin:0;font-size:14px;line-height:1.6;color:#57534b;">
                Thank you for creating your NovaStage account. Your workspace is active and you are officially part of our Beta release (v1.0.7). Start designing your cloud topologies and planning collaborative roadmaps today.
              </p>
            </td>
          </tr>
          <!-- Meta strip -->
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #eeebe5;border-radius:8px;background-color:#f8f6f1;">
                <tr>
                  ...
                  <td style="padding:14px 18px;">
                    ...
                    <p style="margin:0;font-size:13px;font-weight:bold;color:#386233;">Beta v1.0.7</p>
                  </td>
                </tr>
              </table>
            </td>
