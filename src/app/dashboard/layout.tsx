...
export default async function DashboardLayout({
  ...
  return (
    <MobileNavProvider>
      <div className="dashboard-v2 flex min-h-0 h-[calc(100dvh-var(--announcement-height))] overflow-hidden bg-[#fafafa] text-neutral-900 dark:bg-[#0f141c] dark:text-[#f1f5f9] antialiased">
