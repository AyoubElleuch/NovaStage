...
import { AlertCircle, Check, Eye, EyeOff, Loader2, LockKeyhole, Save, ShieldAlert, UserRound, X } from "lucide-react";
...
export function DeleteAccountForm({ fullName }: { fullName?: string | null }) {
  ...
  return (
    <>
      <section
        className="dash-enter rounded-xl border border-red-200 bg-red-50/40 p-5 sm:p-6"
      ...
      >
        ...
        />
        <div className="mt-5 flex flex-wrap items-center justify-between gap-4 border-t border-red-100 pt-5">
          <p className="max-w-lg text-[13px] leading-5 text-red-700/80">
          ...
          <button
            ...
            className="inline-flex h-10 cursor-pointer items-center justify-center gap-2 rounded-lg border border-red-300 bg-white px-4 text-sm font-medium text-red-700 shadow-sm transition-colors hover:border-red-400 hover:bg-red-50 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-red-100"
          >
      ...
      {dialogOpen && (
        ...
        >
          <div
            ...
            className="dash-pop relative w-full max-w-md rounded-2xl border border-red-200 bg-white p-7 shadow-2xl"
          ...
          >
            ...
            <h2 id="delete-account-dialog-title" className="mt-5 text-xl font-semibold tracking-tight text-neutral-900">
              Delete your account?
            </h2>
